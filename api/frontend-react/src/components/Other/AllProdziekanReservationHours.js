...
class ProdziekanReservationHours extends Component {
  ...
  static propTypes = {
      ...
      componentDidMount() {
        this.props.getReservationHours();
      };
  ...
  render() {
    ...
    return (
      <div style={{ maxWidth: "100%" }}>
        <MaterialTable
        icons={tableIcons}
      title="Lista Dyżurów - Prodziekani"
      columns={[
        { 
            title: 'Do Kogo', 
            field: 'do_kogo' 
...
const mapStatetoProps = state => ({
  ...
  export default connect(mapStatetoProps, { getReservationHours, deleteReservationHours })(
